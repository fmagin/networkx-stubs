...
def find_cliques(
    G: Graph[Node], nodes: list[Node] | None = ...
) -> Iterable[list[Node]]: ...
...
def make_clique_bipartite(
    G: Graph[Node], fpos: None = ..., create_using: Type[_G] = Graph, name: None = ...
) -> _G: ...
def graph_clique_number(G: Graph[Node], cliques: list[Node] | None = ...) -> int: ...
def graph_number_of_cliques(
    G: Graph[Node], cliques: list[Node] | None = ...
) -> int: ...
def node_clique_number(
    G: Graph[Node],
    nodes: list[Node] | None = ...,
    cliques: list[list[Node]] | None = ...,
) -> int: ...
