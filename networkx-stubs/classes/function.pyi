...
@overload
def selfloop_edges(G: Graph[_T], data: Literal[False] = False, keys: Literal[False] = ..., default: Any = ...) -> Iterable[tuple[_T, _T]]: ...
@overload
def selfloop_edges(G: Graph[_T], data: Literal[True] = True, keys: Literal[False] = ..., default: Any = ...) -> Iterable[tuple[_T, _T, dict[str, Any]]]: ...
@overload
def selfloop_edges(G: Graph[_T], data: str = ..., keys: Literal[False] = ..., default: _U = None) -> Iterable[tuple[_T, _T, _U]]: ...
@overload
def selfloop_edges(G: Graph[_T], data: Literal[False] = False, keys: Literal[True] = True, default: Any = ...) -> Iterable[tuple[_T, _T, int]]: ...
@overload
def selfloop_edges(G: Graph[_T], data: Literal[True] = True, keys: Literal[True] = True, default: Any = ...) -> Iterable[tuple[_T, _T, int, dict[str, Any]]]: ...
@overload
def selfloop_edges(G: Graph[_T], data: str = ..., keys: Literal[True] = True, default: _U = None) -> Iterable[tuple[_T, _T, int, _U]]: ...
