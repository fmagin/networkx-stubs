...
class Graph(Collection[Node], Generic[Node]):
    ...
    def __init__(
        self, incoming_graph_data: Data[Node] | None = None, **attr: Any
    ) -> None: ...
    ...
    def add_nodes_from(
        self,
        nodes_for_adding: Iterable[Node | tuple[Node, dict[str, Any]]],
        **attr: Any
    ) -> None: ...
    ...
    def add_edges_from(
        self, ebunch_to_add: Iterable[EdgePlus[Node]], **attr: Any
    ) -> None: ...
    ...
    def get_edge_data(
        self, u: Node, v: Node, default: Any = ...
    ) -> Mapping[str, Any]: ...
