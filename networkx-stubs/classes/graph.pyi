...
class Graph(Collection[Node], Generic[Node]):
    ...
    def add_weighted_edges_from(
        self, ebunch_to_add: Iterable[tuple[Node, Node, Any]], weight: str = ..., **attr: Any
    ) -> None: ...
    ...
    @overload
    def update(self, edges: Graph[Node] | Iterable[EdgePlus[Node]] | None = ..., nodes: Iterable[Node] | None = ...) -> None: ...
