...
class NodeView(Generic[Node]):
    ...
    @overload
    def __call__(
        self, data: Literal[False] = ..., default: Any = ...
    ) -> NodeView[Node]: ...
    @overload
    def __call__(
        self, data: Literal[True] | str, default: Any = ...
    ) -> NodeDataView[Node]: ...
    def data(
...
class NodeDataView(Generic[Node]):
    def __init__(
        self, nodedict: dict[str, Any], data: bool | str = ..., default: Any = ...
    ) -> None: ...
    def __len__(self) -> int: ...
...
class DiDegreeView(Generic[Node]):
    ...
    def __call__(
        self, nbunch: NBunch[Node] = ..., weight: None | bool | str = ...
    ) -> DiDegreeView[Node]: ...
...
class OutEdgeView(Generic[Node]):
    ...
    @overload
    def __call__(
        self, nbunch: NBunch[Node] = ..., data: Literal[False] = ..., default: Any = ...
    ) -> OutEdgeView[Node]: ...
    @overload
    def __call__(
        self, *, nbunch: NBunch[Node] = ..., data: Literal[True], default: Any = ...
    ) -> OutEdgeDataView[Node, tuple[Node, Node, dict[str, Any]]]: ...
    @overload
    def __call__(
        self, nbunch: NBunch[Node] = ..., data: str = ..., default: _U = None
    ) -> OutEdgeDataView[Node, tuple[Node, Node, _U]]: ...
    @overload
    def data(
        self,
    ...
    @overload
    def data(
        self, data: Literal[True] = True, default: Any = ..., nbunch: NBunch[Node] = ...
    ) -> OutEdgeDataView[Node, tuple[Node, Node, dict[str, Any]]]: ...
    @overload
    def data(
        self, data: str = ..., default: _U = None, nbunch: NBunch[Node] = ...
    ) -> OutEdgeDataView[Node, tuple[Node, Node, _U]]: ...
