...
from typing import Iterator, Iterable, Tuple, Generic, Mapping, Dict, Any, Tuple, Optional, TypeVar, Hashable
...
class NodeView(Generic[Node]):
    ...
    def __call__(self, data: bool | str = ..., default: Any = ...) -> NodeDataView[Node]: ...
...
class OutEdgeDataView(Generic[Node]):
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[Tuple[Node, Node] | Tuple[Node, Node, Any]]: ...
...
class OutEdgeView(Generic[Node]):
    def __init__(self, graph: Graph[Node]) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[Tuple[Node, Node] | Tuple[Node, Node, Dict[str, Any]]]: ...
    def __contains__(self, e: Edge[Node]) -> bool: ...
    def __getitem__(self, e: Edge[Node]) -> Dict[str, Any]: ...
    def __call__(self, nbunch: NBunch[Node] = ..., data: bool | str = ..., default: Any = ...) -> OutEdgeDataView[Node]: ...
