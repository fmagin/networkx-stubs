...
def read_graphml(path: Any, node_type: Any = ..., edge_key_type: Any = ...) -> Incomplete: ...
def parse_graphml(graphml_string: Any, node_type: Any = ...) -> Incomplete: ...
...
class GraphMLWriter(GraphML):
    ...
    def attr_type(self, name: Any, scope: Any, value: Any) -> Incomplete: ...
    def get_key(self, name: Any, attr_type: Any, scope: Any, default: Any) -> Incomplete: ...
    def add_data(
        self,
        name: Any,
        element_type: Any,
    ...
    def add_attributes(
        self, scope: Any, xml_obj: Any, data: Any, default: Any
    ) -> None: ...
...
class GraphMLReader(GraphML):
    ...
    def make_graph(
        self, graph_xml: Any, graphml_keys: Any, defaults: Any, G: Any | None = ...
    ) -> Any: ...
    def add_node(
        self, G: Any, node_xml: Any, graphml_keys: Any, defaults: Any
    ) -> None: ...
    def add_edge(self, G: Any, edge_element: Any, graphml_keys: Any) -> None: ...
    def decode_data_elements(self, graphml_keys: Any, obj_xml: Any) -> Incomplete: ...
    def find_graphml_keys(self, graph_element: Any) -> Incomplete: ...
