...
class GraphMLWriter(GraphML):
    ...
    def add_data(self, name: Any, element_type: Any, value: Any, scope: str = ..., default: Any | None = ...): ...
...
class GraphMLReader(GraphML):
    ...
    def make_graph(self, graph_xml: Any, graphml_keys: Any, defaults: Any, G: Any | None = ...): ...
